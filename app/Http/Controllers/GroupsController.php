...
class GroupsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('groups.index',['g_groups'=>$getAllgroup,'g_location' => $g_location,'image'=>$image,'getAllroom'=>$getAllroom,'getAllgroup'=>$getAllgroup,'name_user'=>$name_user,'id_user'=>$id_user,'type_user'=>$type_user]);
    }
