                ...
                <h5 class="text-right">
                    @if($type_user == 1)
                        <div id="status-header">
                            ...
                            <a href="{{url('/index/profile/'.Crypt::encrypt($id_user))}}"><label class="control-label"
                                                                                                 style="color: #fff;">{{$name_user}}</label></a>
                        </div>
                    @elseif($type_user == 2)
                        <div id="status-header">
                            <img src="{{url('public/images/'.$image)}}"/>
                    ...
                    <div class="open-nav">
                        ...
                        <ul class="sub-menu">
                          @if($type_user == 1)
                                ...
                                <li><a href="{{url('/groups')}}"><i
                                                class="fa fa-users"></i> Group & Room Manage</a></li>
                                <li><a href="{{url('/home')}}"><i class="fa fa-calendar"></i> Calendar</a></li>
                                <li><a href="{{url('/location')}}"><i
                                                class="fa fa-location-arrow"></i> location</a></li>
                            ...
                            @else
                                ...
                                <li><a href="{{url('/index/register')}}"><i
        ...
        @if($type_user == 1)
            <div id="network">
                <ul>
                    ...
                    <a href="#" data-toggle="modal" data-target="#divPopUpSignContract">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input id="btnSubmitSign" class="btn btn-info pull-left" type="button" data-inline="true"
                       data-mini="true" data-theme="b" value="Submit Sign" onclick="fun_submit()"/>
                <input id="btnClearSign" class="btn btn-info pull-left" type="button" data-inline="true"
                       data-mini="true" data-theme="b" value="news" onclick="init_Sign_Canvas()"/>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $(document).delegate('.open-nav', 'click', function (event) {
